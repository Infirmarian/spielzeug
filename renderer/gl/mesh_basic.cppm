...
export module spz.renderer.gl:mesh_basic;

namespace spz::renderer::gl
{
export class Mesh_Basic
{
 private:
  uint32_t m_vao;
 ...
 public:
  ...
  static Mesh_Basic create_mesh(const std::array<float, N>& vertices)
  {
    ...
    return Mesh_Basic{VAO, num_vertices};
  }
 ...
 private:
  Mesh_Basic(const uint32_t vao, const uint32_t n_vertices)
